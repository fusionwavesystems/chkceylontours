    ...
    return (
        <div style={{ backgroundColor: '#000', minHeight: '100vh', color: '#fff', overflow: 'hidden' }}>
            ...
            <section style={{
                ...
                textAlign: 'center',
                padding: '0 20px',
                background: 'linear-gradient(to bottom, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.9) 100%), url("https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1920&auto=format&fit=crop") center/cover no-repeat'
            }}>
